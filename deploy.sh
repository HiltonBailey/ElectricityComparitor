...
if [ "$HTTP_CODE" = "204" ] || [ "$HTTP_CODE" = "200" ]; then
    ...
    SEED_CODE=$(curl -s -m 10 -o /dev/null -w "%{http_code}" \
        ...
        --data-urlencode "off_fit_1=0.1" \
        --data-urlencode "sh_fit_1=0.1" \
        --data-urlencode "pk_fit_1=0.1" \
        ...
        --data-urlencode "off_fit_s_2=17" \
        --data-urlencode "off_fit_e_2=21" \
        --data-urlencode "sh_fit_s_2=17" \
        --data-urlencode "sh_fit_e_2=21" \
        --data-urlencode "pk_fit_s_2=17" \
        --data-urlencode "pk_fit_e_2=21" \
        --data-urlencode "billing_day_2=4" \
        --data-urlencode "glo_rebate_2=0" \
        --data-urlencode "name_3=CovaU SolarMax" \
        --data-urlencode "model_3=fixed_tou" \
        --data-urlencode "dsc_3=1.52" \
        --data-urlencode "sh_pk_3=0.165" \
        --data-urlencode "pk_pk_3=0.6139" \
        --data-urlencode "sp_fit_3=0.15" \
        --data-urlencode "sp_limit_3=30" \
        --data-urlencode "off_s_3=11" \
        --data-urlencode "off_e_3=14" \
        --data-urlencode "pk_s_3=15" \
        --data-urlencode "pk_e_3=21" \
        --data-urlencode "sp_s_3=17" \
        --data-urlencode "sp_e_3=21" \
        --data-urlencode "off_fit_s_3=17" \
        --data-urlencode "off_fit_e_3=21" \
        --data-urlencode "sh_fit_s_3=17" \
        --data-urlencode "sh_fit_e_3=21" \
        --data-urlencode "pk_fit_s_3=17" \
        --data-urlencode "pk_fit_e_3=21" \
        --data-urlencode "sp_fit_s_3=17" \
        --data-urlencode "sp_fit_e_3=21" \
        --data-urlencode "ev_e_3=6" \
        --data-urlencode "ev_pk_3=0.15" \
        --data-urlencode "off_limit_3=24" \
        --data-urlencode "billing_day_3=4" \
        --data-urlencode "name_4=Amber" \
        --data-urlencode "model_4=variable" \
        --data-urlencode "dsc_4=1.76" \
        --data-urlencode "sub_4=25" \
        --data-urlencode "billing_day_4=4" \
        --data-urlencode "exp_rate_4=1" \
        --data-urlencode "name_5=Globird New VPP" \
        --data-urlencode "model_5=fixed_tou" \
        --data-urlencode "dsc_5=1.584" \
        --data-urlencode "sh_pk_5=0.407" \
        --data-urlencode "pk_pk_5=0.528" \
        --data-urlencode "pk_fit_5=0.02" \
        --data-urlencode "sp_fit_5=0.1" \
        --data-urlencode "sp_limit_5=15" \
        --data-urlencode "off_s_5=11" \
        --data-urlencode "off_e_5=14" \
        --data-urlencode "pk_s_5=16" \
        --data-urlencode "pk_e_5=23" \
        --data-urlencode "sp_s_5=18" \
        --data-urlencode "sp_e_5=21" \
        --data-urlencode "billing_day_5=4" \
        --data-urlencode "glo_rebate_5=1" \
        --data-urlencode "name_6=Globird Four4Free" \
        --data-urlencode "model_6=fixed_tou" \
        --data-urlencode "dsc_6=1.30174" \
        --data-urlencode "sh_pk_6=0.36385" \
        --data-urlencode "pk_pk_6=0.58152" \
        --data-urlencode "pk_fit_6=0.08" \
        --data-urlencode "off_s_6=11" \
        --data-urlencode "off_e_6=15" \
        --data-urlencode "pk_s_6=16" \
        --data-urlencode "pk_e_6=23" \
        --data-urlencode "pk_fit_s_6=16" \
        --data-urlencode "pk_fit_e_6=23" \
        --data-urlencode "off_limit_6=50" \
        --data-urlencode "billing_day_6=4" \
        --data-urlencode "glo_rebate_6=0" \
        --data-urlencode "name_7=Origin Battery Starter" \
        --data-urlencode "model_7=fixed_tou" \
        --data-urlencode "dsc_7=1.2567" \
        --data-urlencode "off_pk_7=0.33" \
        --data-urlencode "sh_pk_7=0.33" \
        --data-urlencode "pk_pk_7=0.5731" \
        --data-urlencode "off_fit_7=0.05" \
        --data-urlencode "sh_fit_7=0.05" \
        --data-urlencode "pk_fit_7=0.18" \
        --data-urlencode "sp_fit_7=0.18" \
        --data-urlencode "sp_limit_7=999" \
        --data-urlencode "sp_s_7=17" \
        --data-urlencode "sp_e_7=21" \
        --data-urlencode "off_fit_s_7=17" \
        --data-urlencode "off_fit_e_7=21" \
        --data-urlencode "sh_fit_s_7=17" \
        --data-urlencode "sh_fit_e_7=21" \
        --data-urlencode "pk_fit_s_7=17" \
        --data-urlencode "pk_fit_e_7=21" \
        --data-urlencode "sp_fit_s_7=17" \
