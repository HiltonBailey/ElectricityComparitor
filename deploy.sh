...
SEED_CODE=$(curl -s -m 10 -o /dev/null -w "%{http_code}" \
    ...
    --data-urlencode "pk_fit_6=0.28" \
    --data-urlencode "sp_fit_6=0.03" \
    --data-urlencode "off_s_6=21.0" \
    --data-urlencode "off_e_6=15.0" \
    --data-urlencode "pk_s_6=15.0" \
    --data-urlencode "pk_e_6=21.0" \
    --data-urlencode "pk_fit_s_6=17.0" \
    --data-urlencode "pk_fit_e_6=21.0" \
    --data-urlencode "sp_fit_s_6=7.0" \
    --data-urlencode "sp_fit_e_6=8.0" \
    ...
    --data-urlencode "bat_cap_7=41.92" \
