    ...
    SEED_CODE=$(curl -s -m 10 -o /dev/null -w "%{http_code}" \
        ...
        --data-urlencode "pk_e_2=21" \
         --data-urlencode "billing_day_2=4" \
          ...
          --data-urlencode "off_pk_3=0" \
          --data-urlencode "sh_pk_3=0.1650" \
          ...
          --data-urlencode "pk_fit_s_3=18" \
          --data-urlencode "pk_fit_e_3=21" \
          --data-urlencode "sp_fit_s_3=18" \
          --data-urlencode "sp_fit_e_3=21" \
          --data-urlencode "ev_s_3=6" \
          --data-urlencode "ev_e_3=11" \
          --data-urlencode "ev_pk_3=0.2802" \
          --data-urlencode "off_limit_3=50" \
